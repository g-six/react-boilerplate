...
The [issue tracker](https://github.com/idearobin/skyrun/issues) is
...
Package updates are welcome. But take a moment to find out whether your package fits with the scope and aims of the project. It's up to *you* to make a strong case to convince the project's [maintainers](./MAINTAINERS.md) of the merits of this feature. Please provide as much detail and context as possible.
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
   ...
   git clone https://github.com/<your-username>/reduxions.git
   # Navigate to the newly cloned directory
   cd reduxions
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/idearobin/skyrun.git
   ```
...
There are few basic rules to ensure high quality of the reduxion:
